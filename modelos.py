class FundoImobiliario:
    def __init__(self, codigo, segmento, cotacao_atual, ffo_yeld, dividend_yeld, p_vp, valor_mercado,
                 liquidez, qt_imoveis, preco_m2, aluguel_m2, cap_rate, vacancia_media):
        self.codigo = codigo
        self.segmento = segmento
        self.cotacao_atual = cotacao_atual
        self.ffo_yeld = ffo_yeld
        self.dividend_yeld = dividend_yeld
        self.p_vp = p_vp
...
class Estrategia:
    def __init__(self, segmento="", cotacao_atual_minima=0, ffo_yeld_minimo=0, dividend_yeld_minimo=0, p_vp_minimo=0,
        ...
        self.ffo_yeld_minimo = ffo_yeld_minimo
        self.dividend_yeld_minimo = dividend_yeld_minimo
    ...
    def aplica_estrategia(self, fundo: FundoImobiliario):
        ...
        if fundo.cotacao_atual < self.cotacao_atual_minima \
                ...
                or fundo.dividend_yeld < self.dividend_yeld_minimo \
